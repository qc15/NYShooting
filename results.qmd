...
##1, Number of Incidents over Years
...
##2,Cyclic pattern of shooting incident over year
```{r}
...
##4,The relationship between occur time and borough
```{r}
...
##8,Relationship between perpetrators and victims, based on age
```{r}
df_clean_age <- df |>
